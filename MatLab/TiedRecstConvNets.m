function [dkernels, hbias, obias, params, decoder, map, rerror] = TiedRecstConvNets(X, acttype, dkernels,...
    hbias, obias, params, stride, test_mode, varargin)
...
switch acttype
    case 'max'
        mapp = maxAct(encoder);
    case 'sigmoid'
        mapp = sigmoidAct(encoder);
    case 'tanh'
        mapp = tanhAct(encoder);
    otherwise
        return;
end
